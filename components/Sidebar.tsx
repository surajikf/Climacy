...
const navigation = [
    { name: "Data Sources", href: "/import", icon: DownloadCloud },
    { name: "Clients", href: "/clients", icon: Users },
    { name: "Access", href: "/admin", icon: ShieldAlert, adminOnly: true },
        ...
        if (authStatus === "authenticated") {
            const fetchSidebarStats = async () => {
                try {
                    ...
                    console.error("Sidebar stats request failed", error);
                }
            };
            fetchSidebarStats();
        }
