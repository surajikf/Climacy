...
async function resolveGmailAuth(
    ...
    if (!isConfigurationValid) {
        return { success: false, error: "Gmail configuration incomplete. No Primary Dispatcher linked for this user. Please connect your Gmail account in Settings." };
    }
    ...
    console.log(`[MAIL] Resolved Gmail identity: ${gmailUser} (Source: ${activeCreds.source})`);
