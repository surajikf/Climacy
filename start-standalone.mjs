...
// Standalone output is at .next/standalone/server.js for a monolith build
const serverEntrypoint = join(workspaceDir, ".next", "standalone", "server.js");

if (!existsSync(serverEntrypoint)) {
  console.error(`Server entrypoint not found: ${serverEntrypoint}`);
